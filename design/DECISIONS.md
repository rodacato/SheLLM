...
**Status:** 19 entries · 16 resolved · 3 open · 0 🔴 high-impact · 0 🐞 unfiled bugs.
...
**`D66`** (the read stamp), with `D67` following. The rule from the D30/D31 collision applies
...
**Next free number: D67.** D15–D20, D43–D49 and D61–D66 are this file's own and are above; D50–D60
