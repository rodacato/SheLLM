...
|---|---|---|---|
| `admin.pen` | 2 of 5 drawn — Overview, Request Logs. API Keys, Playground, System pending | **0.1.1** | `/admin/dashboard/`, sidebar in [`src/admin/public/js/app.js:209`](../src/admin/public/js/app.js#L209) |
