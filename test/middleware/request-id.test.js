...
describe('request-id', () => {
  it('uses x-request-id header when present', () => {
    ...
    assert.strictEqual(res.headers['x-request-id'], 'header-id-123', 'the caller gets it back to quote');
